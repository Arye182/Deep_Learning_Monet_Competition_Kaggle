...
\section{Code}
\href{https://github.com/Arye182/Deep_Learning_Monet_Competition_Kaggle}
%%%%%%%%%%% bibliography %%%%%%%%%%%%%%%%%%%%%%%%%%
\bibliographystyle{plain}
\bibliography{references}
\begin{thebibliography}{100}
\bibitem{1} https://arxiv.org/pdf/1703.10593.pdf
\bibitem{2}https://www.tensorflow.org/tutorials/generative/cyclegan
\end{thebibliography}
%%%%%%%%%% end bibliography %%%%%%%%%%%%%%%%%%%%%%%
\end{document}